...
class Fertilizer(db.Model, SerializerMixin):
    ...
    #         "name": self.name,
    #         "Type": self.Type,
    #         "NutrientComposition": self.NutrientComposition,
    #         "Manufacturer": self.Manufacturer,
    #         "ApplicationMethod": self.ApplicationMethod,
    #         "ApplicationRate": self.ApplicationRate,
    #         "PackagingSize": self.PackagingSize,
    #         "Price": self.Price,
    #         "ExpirationDate": self.ExpirationDate,
    #         "SafetyInformation": self.SafetyInformation,
    #         "UsageInstructions": self.UsageInstructions,
    #         "StorageConditions": self.StorageConditions,
    #         "EnvironmentalImpact": self.EnvironmentalImpact
    #     }
...
class Inventory(db.Model, SerializerMixin):
    ...
    #         "lastRestockedDate" self.lastRestockedDate,
    #         "id": self.id,
    #         "id": self.id
    #     }
...
class Depot(db.Model, SerializerMixin):
    ...
    inventories = db.relationship('Inventory', backref='depot', lazy='dynamic')
...
class Transaction(db.Model, SerializerMixin):
    ...
    #     return{
    #         "id": self.id,
    #         "transcationType": self.transcationType,
...
class Payment(db.Model, SerializerMixin):
    ...
    #         "transcationReference": self.transcationReference,
...
class Supplier(db.Model, SerializerMixin):
    ...
    #         "suppliedFertilizers": self.suppliedFertilizers,
    #         "contractDetails": self.contractDetails
    #     }